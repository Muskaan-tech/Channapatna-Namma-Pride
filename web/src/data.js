// ─── Data ──────────────────────────────────────────────────────────
// Product images are AI-generated Channapatna toy images, served locally
// from /public/images/  — no external dependency, always loads instantly.
...
export const artisans = [
  {
    id: 'artisan_001',
    name: 'Nagaraj K.',
    bio: 'A third-generation master craftsman from Channapatna, Nagaraj has spent 28 years perfecting the traditional lacquering technique passed down by his grandfather. His Gombe dolls have been exhibited in Delhi and London.',
    location: 'Channapatna, Karnataka',
    rating: 5.0,
    photoUrl: '/images/artisan_001.png',
  ...
  },
  {
    ...
    rating: 4.8,
    photoUrl: '/images/artisan_002.png',
  ...
  },
  {
    ...
    location: 'Channapatna, Karnataka',
    rating: 4.9,
    photoUrl: '/images/artisan_003.png',
...
export const products = [
  ...
  },
  {
    ...
    story: "Ravi carves each rocking horse from a single block of ivory wood, shaping the mane and tail with a small hand chisel. The gentle rocking motion is the result of precisely balanced runners — a technique Ravi learned from his father at the age of twelve. Every horse has a name, whispered by Ravi before it leaves the workshop.",
    rating: 4.7,
    isVerified: true,
  },
  {
    ...
    story: "The elephant holds a sacred place in Karnataka's heart. Nagaraj spends an entire afternoon shaping the trunk alone — the slight upward curve that signifies good luck is the very last detail he adds before signing the base with his thumb print.",
    rating: 4.6,
    isVerified: true,
  },
  {
    ...
    story: "Every year during Dasara, thousands of Gombe dolls are arranged in homes across Karnataka. This doll is Nagaraj's tribute to that tradition — a small keeper of memory, bright enough to light up any room and warm enough to carry a century of joy.",
    rating: 4.9,
    isVerified: true,
  },
  {
    ...
    story: "The spinning top is Ravi's favourite piece to make. He says the secret is in the tip — a tiny brass point he hammers in by hand. 'A bad tip,' he laughs, 'and the top dances drunk.' Each one is tested a hundred times before it earns its painted rings.",
    rating: 4.5,
    isVerified: true,
  },
  {
    ...
    story: "Shobha paints each flower petal freehand, without a stencil. She says her mother taught her that a flower drawn with a ruler has no soul. Every petal on this vase was placed with a breath held and a steady hand — a meditation in colour.",
    rating: 4.7,
    isVerified: true,
  },
];
...
export const verificationCodes = [
  { code: '847291', productId: 'prod_001', artisanId: 'artisan_001', status: 'active' },
  { code: '731456', productId: 'prod_002', artisanId: 'artisan_003', status: 'active' },
  { code: '956234', productId: 'prod_003', artisanId: 'artisan_001', status: 'active' },
  { code: '612847', productId: 'prod_004', artisanId: 'artisan_001', status: 'active' },
  { code: '382901', productId: 'prod_005', artisanId: 'artisan_003', status: 'active' },
  { code: '495673', productId: 'prod_006', artisanId: 'artisan_002', status: 'active' },
];

export const getArtisan = (id) => artisans.find((a) => a.id === id);
export const getProduct  = (id) => products.find((p) => p.id === id);
export const verifyCode  = (code) => verificationCodes.find((v) => v.code === code && v.status === 'active');
